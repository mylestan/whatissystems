var content = {
	...
	'our-history' : {
		'section' : 'about',
		'cssId' : "our-history",
		'detailTitle' : 'Our History',
		'detailContent': '<p>How does such a unique program such as Systems Design Engineering come to be? Over the years, the program has been re-modelled and shifted into many different forms, and it continues to change to this day, absorbing the influences of the people within it. This timelie outlines the key turning point in SyDe history. It is adapted from an Alumni&#039s investigation into the matter, titled <a href="res/origins-of-syde-abridged.pdf" target="_blank">The Origins of SyDe, Abridged</a>, which is an excellent read if you have a few minutes to spare.</p><div class="timeline-entry"><div class="timeline-date"><p>1960</p></div><div class="timeline-connector"></div><div class="timeline-content"><p>George Soulis, a distinguished engineer, joins the University of Waterloo. Soulis realizes that throughout his career, he has never received formal education in design; his only experience comes from what he has learned in industry. Realizing the importance of education in design, he develops an idea of how to teach design to the engineering body. Soulis travels to the High School for Design in Germany to study.</p><p>Peter Roe, a PhD student in Electrical Engineering at the time, is finishing up his dissertation in Systems Analysis. However, Roe’s strong interest in engineering design leads to him being send to Dartmoth University by Dr. Kesavan to participate in an experiment in teaching Engineering Design.</p></div></div><div class="clear"></div><div class="timeline-entry"><div class="timeline-date"><p>1963</p></div><div class="timeline-connector"></div><div class="timeline-content"><p>Roe and Soulis return to Canada. Along with Professor Handa, they convince the Dean of Engineering to allow them to teach General Engineering 11, the first mandatory first-year engineering course, focusing on Engineering Design. Students participated in design workshops and the course would end in ‘design showdowns’, where students would compete against each other for prizes - uWaterloo beer steins. This course eventually became Systems Design’s 1st year design course - SYDE161.</p></div></div><div class="clear"></div><div class="timeline-entry"><div class="timeline-date"><p>1964</p></div><div class="timeline-connector"></div><div class="timeline-content"><p>Soulis, Roe, and Professor Johann create the Institute of Design at the University of Waterloo. The institute is created to take on industrial design and engineering contracts, and quickly lands a large deal to design 3 of the 6 pavilions for the Expo ’67 in Montreal.</p></div></div><div class="clear"></div><div class="timeline-entry"><div class="timeline-date"><p>1965</p></div><div class="timeline-connector"></div><div class="timeline-content"><p>Funding from the Institute of Design’s contract work allows for expansion. The Department of Design is created after a vocal floor fight at a faculty meeting saw it approved by a margin of one vote. The Department of Design offered a diploma program and a masters program as well as holding responsibilities for teaching the undergraduate design and graphics courses. An undergraduate and Ph.D program were added shortly after. Professionals from all background were brought in to fill positions within the faculty’s staff.</p></div></div><div class="clear"></div><div class="timeline-entry"><div class="timeline-date"><p>1968</p></div><div class="timeline-connector"></div><div class="timeline-content"><p>Restructuring at the university along with efforts by Kesavan saw the Department of Design become the Department of Systems Design Engineering under the Department of Management Sciences. The undergraduate program consisted of three years of general study, one year of specialization, and one year of deep study. Systems Design Engineering students had access to a great range of specializations which reflected the unique background of the faculty staff.</p></div></div><div class="clear"></div><div class="timeline-entry"><div class="timeline-date"><p>1968</p></div><div class="timeline-connector"></div><div class="timeline-content"><p>The first official class of Systems Design Engineering Students begins at the University of Waterloo; 60 students are admitted.</p></div></div>'
	},
	'syde-vs-the-rest' : {
		'section' : 'about',
